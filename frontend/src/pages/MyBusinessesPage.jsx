...
export default function MyBusinessesPage({ user, refreshBalance, updateBalance }) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.error('[AUTH99] Failed to fetch businesses:', error);
                        ...
                        <div className="p-3 bg-white/5 rounded-lg mb-3">
                          ...
                          <div className="flex justify-between text-sm mb-2">
                            ...
                            {(() => {
                              ...
                              // Арендованный бизнес 0-го уровня: пока аренда идёт,
                              // он РАБОТАЕТ. Статуса «Изъят»/«На продаже» у него быть
                              // не может — при изъятии он просто удаляется отовсюду.

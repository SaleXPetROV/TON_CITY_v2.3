...
BLOCKED_WRITES_DURING_TUTORIAL = [
    ...
    "/api/chat/messages",
    "/api/chat/send",
    # Real marketplace is OFF-LIMITS during the tutorial. The tutorial has its
    # OWN isolated endpoints (/api/tutorial/create-lot, /api/tutorial/buy-lot);
    # the real ones are never needed here. Blocking them prevents a user from
    # calling the API directly to (a) list tutorial-granted resources on the
    # public market, or (b) buy real players' resources with the temporary
    # 50-TON practice balance (which would pay a real seller real TON that the
    # buyer's balance restore then "refunds", i.e. money creation).
    "/api/market/list",   # covers /market/list AND /market/list-resource
    "/api/market/buy",
]
...
TUTORIAL_STEPS = [
    ...
    {"id": "go_island", "index": 1, "target_route": "/maps", "target_selector": "sidebar-nav-map", "mobile_target_selector": "bottom-nav-map", "gate": "page_visit", "optional": False, "auto_advance_on_arrival": True},
    {"id": "pick_ton_island", "index": 2, "target_route": "/island", "target_selector": "city-card-ton-island", "mobile_target_selector": "city-card-ton-island", "gate": "page_visit", "optional": False},
    ...
    {"id": "go_businesses", "index": 4, "target_route": "/my-businesses", "target_selector": "sidebar-nav-my-businesses", "mobile_target_selector": "bottom-nav-business", "gate": "page_visit", "optional": False},
    ...
    {"id": "go_trading_buy", "index": 6, "target_route": "/trading", "target_selector": "sidebar-nav-trading", "mobile_target_selector": "bottom-nav-trading", "gate": "page_visit", "optional": False},
    ...
    {"id": "observe_listing", "index": 10, "target_route": "/trading", "target_selector": None, "mobile_target_selector": None, "gate": "client_ack", "optional": False},
    {"id": "go_businesses_check", "index": 11, "target_route": "/my-businesses", "target_selector": "sidebar-nav-my-businesses", "mobile_target_selector": "bottom-nav-business", "gate": "page_visit", "optional": False},
    {"id": "explain_t3_buff", "index": 12, "target_route": "/my-businesses", "target_selector": "resource-card-neuro_core", "mobile_target_selector": "resource-card-neuro_core", "gate": "client_ack", "optional": False, "allow_interaction": True},
    ...
    {"id": "finish", "index": 14, "target_route": None, "target_selector": None, "mobile_target_selector": None, "gate": "client_ack", "optional": False},
]

...
def main():
    ...
    seeds = [
        {"email": "sanyanazarov212@gmail.com", "username": "admin", "password": "Qetuyrwioo", "is_admin": True},
        {"email": "testuser@example.com", "username": "testuser", "password": "Test1234!", "is_admin": False},
    ]
